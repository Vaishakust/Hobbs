...
public class NewPage {
	...
	@FindBy(xpath = "//span[normalize-space()='New In1234']")
	private WebElement span_mSNewIn;
	@FindBy(xpath = "//button[@class='add-to-cart btn btn-secondary']")
	...
	public void add_producttotheCart() throws InterruptedException {
		JavascriptExecutor yu = (JavascriptExecutor) driver;
		Thread.sleep(5000);
		yu.executeScript("arguments[0].scrollIntoView(true);", button_nLAddtoBag);
